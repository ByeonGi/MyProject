...
// //array.prototype.filter
// //반복문을 내부 반복으로 숨겨 배열을 필터링 할떄 사용함

// var arr = [1,2,3,4,5].filter(function(num, idx){
//     return num %2 == 0;
// })
...
var arr2 = [1,2,3,4,5].map(function(num, idx){
    return num * 2;
})
...
var result = [1,2,3,4,5].some(function(num, idx){
    return num ===3;
})

var ressult2 = [1,2,3,4,5].every(function(num, idx){
    return num < 20;
})

var result3 = [10,20,30,40,50].reduce(function(num1, num2){
    return num1 + num2;
},10);

var result4 = [10,20,30,40,50].reduceRight(function(num1, num2){
    return num1 - num2;
})

var result5 = [10,20,30,40,50].indexOf(10);

//인자로 전달된 요소가 있는 인덱스를 반환한다.

var result6 = [10,20,30,40,50].lastIndexOf(10);
